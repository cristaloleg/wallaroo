...
actor Main
  new create(env: Env) =>
    ...
    try
      ...
      ifdef not ("python2" or "python3") then
        FatalUserError("You must provide build Machida with either -D " +
          "python2 or -D python3.")
      end
      ifdef "python2" and "python3" then
        FatalUserError("You must choose either -D python2 or -D python3, " +
          "but not both.")
      end
